        ...
        <div style={{ marginLeft: "120px" , marginTop:20 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: "space-between" }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <p style={{marginLeft:10}}>Arnifi</p>
                </div>
                <div>
...
Transparency and Cost-Effectiveness.</p>
            ...
            <p style={{textAlign:'start' , }}>Arnifi We offer expert guidance on business setup, including local laws, entity structure, licensing, and more, to simplify the process for you.</p>
            <div onClick={handleShowmodal} style={{cursor:"pointer"}}>
